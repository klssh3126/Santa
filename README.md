...
| (Front) 메인 <br> (Back) 브랜치관리, 회원등록 <br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  상품평 등록/수정  |  김영욱(팀장) | main.html | localhost:8080 |     
| (Front) 회원가입 <br> (Back) 관리자페이지, 이미지업로드 | 황상하 | signup.html | localhost:8080/signup
| (Front) 고객센터 <br> (Back)  장바구니, 주문, <br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | 양시현 |  customercenter.html |   localhost:8080/customerCenter/
